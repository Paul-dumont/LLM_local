#!/usr/bin/env python3
"""
Run inference-only prediction on all 500 patients (input_500) using the
already fine-tuned 46-CDE / 500-patient model (no retraining - this model
was trained in the Aim3 sweep, see
Qwen7B-instruct/model/qwen_full_7B_cde46_20260716_122634_local/training_config.json).

pred_cde_46/ only has the 100 held-out eval patients; this script regenerates
predictions for all 500 patients from scratch.

Output: Qwen7B-instruct/pred_cde_46_full500/*_pred.txt (500 files)
"""
import re
...
MODEL_PATH = Path(__file__).resolve().parent / "model" / "qwen_full_7B_cde46_20260716_122634_local" / "final_model"
DATA_INPUT = REPO_ROOT / "data_training" / "500_1600_raw_harmo" / "input_500"
OUT_DIR = Path(__file__).resolve().parent / "pred_cde_46_full500"
