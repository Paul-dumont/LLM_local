...
# data_dir = '/home/luciacev/Desktop/LLM_local/data_training/data_output_clean_46_harmo'
data_dir = '/home/luciacev/Desktop/LLM_local/Qwen7B-instruct/save_data_before_reduce_features/predict_Qwen7B_all_harmo'

files = [f for f in os.listdir(data_dir) if f.endswith('_pred.txt')]
...
# Write to CSV
output_file = '/home/luciacev/Desktop/LLM_local/dashboard_ref/patient_data_model_harmo.csv'
