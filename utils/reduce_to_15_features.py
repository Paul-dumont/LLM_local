#!/usr/bin/env python3
"""
Réduire les features de 46 à 15 en supprimant 31 critères spécifiques
À partir de data_output_clean_46, crée data_output_clean_15
"""
from pathlib import Path

# Features à supprimer (31 au total)
FEATURES_TO_REMOVE = {
    "pain_aggravating_factors",     # 77.60%
    "average_daily_pain_intensity", # 77.40%
    "airway_obstruction_present",   # 73.20%
    "pain_onset_date",              # 70.80%
    "appliance_history",            # 68.20%
    "current_medications",          # 67.00%
    "headache_location",            # 66.20%
    "muscle_pain_location",         # 65.20%
    "muscle_symptoms_present",      # 56.40%
    "muscle_pain_score",            # 55.00%
    "hearing_loss_present",         # 53.60%
    "jaw_clicking",                 # 53.20%
...
def main():
    ...
    OUTPUT_DIR = BASE_DIR / "data_training" / "data_output_clean_15"
    ...
    print(f"📊 RÉDUCTION: 46 → 15 features")
    ...
    print(f"   📊 Features conservées: 15/46")
    print("="*70)
